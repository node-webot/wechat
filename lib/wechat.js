    ...
    req.on('end', function () {
      ...
      if (xml) {
        parser.parseString(xml, function (err, result) {
          ...
          var callback = typeof handle === 'function' ? handle : handle.getHandler(weixin.MsgType);
          req.weixin = weixin;
...
Handler.prototype.getHandler = function (type) {
  return this.handlers[type] || function (info, req, res, next) {
    next();
  };
};
