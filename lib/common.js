...
API.prototype.getAccessToken = function (callback) {
  ...
  urllib.request(url, {dataType: 'json'}, wrapper(function (err, data) {
    ...
    that.expireTime = new Date().getTime() + that.tokenDuration;
    callback(err, data);
  }));
  return this;
};
 ...
 * @param {Function} callback 回调函数
 */
API.prototype.checkValid = function (callback) {
  var isValid = !!this.token && (new Date().getTime()) < this.expireTime;
  if( isValid ) {
    callback();
  } else {
...
API.prototype.createMenu = function (menu, callback) {
  var that = this;
  that.checkValid(function(err) {
    if(err) callback(err);

    var url = that.prefix + 'menu/create?access_token=' + that.token;
...
API.prototype.getMenu = function (callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'menu/get?access_token=' + that.token;
...
API.prototype.removeMenu = function (callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'menu/delete?access_token=' + that.token;
    urllib.request(url, {dataType: 'json'}, wrapper(callback));
  });
};
...
API.prototype.getQRCode = function (data, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'qrcode/get?access_token=' + that.token;
...
API.prototype.createTmpQRCode = function (sceneId, expire, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'qrcode/create?access_token=' + that.token;
    var data = {
...
API.prototype.getGroups = function (callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'groups/get?access_token=' + that.token;
    urllib.request(url, {dataType: 'json'}, wrapper(callback));
  });
};
...
API.prototype.createGroup = function (name, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'groups/create?access_token=' + that.token;
    var data = {
      "group": {"name": name}
    };
    urllib.request(url, postJSON(data), wrapper(callback));
...
API.prototype.updateGroup = function (id, name, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'groups/update?access_token=' + that.token;
    var data = {
...
API.prototype.moveUserToGroup = function (openid, groupId, callback) {
  ...
  // to_groupid必须为字符串，加.toString()
  var that = this;
  that.checkValid(function(err) {
    if(err) callback(err);

    var url = that.prefix + 'groups/members/update?access_token=' + that.token;
    var data = {
      "openid": openid,
      "to_groupid": groupId.toString()
    };
    urllib.request(url, postJSON(data), wrapper(callback));
  });
};
...
API.prototype.getUser = function (openid, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'user/info?openid=' + openid + '&access_token=' + that.token;
    urllib.request(url, {dataType: 'json'}, wrapper(callback));
  });
};
...
API.prototype.getFollowers = function (nextOpenid, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'user/get?access_token=' + that.token;
    if (nextOpenid) {
...
API.prototype.sendText = function (openid, text, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.prefix + 'message/custom/send?access_token=' + that.token;
    var data = {
      "touser": openid,
      "msgtype": "text",
      "text": {
...
API.prototype.getMedia = function (mediaId, callback) {
  ...
  that.checkValid(function(err) {
    ...
    var url = that.fileServerPrefix + 'media/get?access_token=' + that.token + '&media_id=' + mediaId;
